...
public:
    ...
    void sendFullFrame()
    {
        ...
        // Single atomic read â€” guarantees maxFrames and rateCode are consistent
...
private:
    ...
    void hiResTimerCallback() override
    {
        ...
        // Single atomic read â€” guarantees QF interval and rate code are consistent
        FrameRate fps = currentFps.load(std::memory_order_relaxed);
