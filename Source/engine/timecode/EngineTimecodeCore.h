...
{
    FPS_2398  = 0,  // 23.976 (24000/1001) â€” cinema/digital workflows
    FPS_24    = 1,
    FPS_25    = 2,
    FPS_2997  = 3,
    FPS_30    = 4
...
// (the Â±30 frame range used by output offsets) because DF skips only occur
...
inline Timecode offsetTimecode(const Timecode& tc, int offsetFrames, FrameRate fps)
{
    ...
    // linearâ†’DFâ†’linear for large offsets accumulates error. The UI sliders
    // are constrained to Â±30 frames; assert here to catch any future misuse.
...
// including drop-frame â†” non-drop-frame conversions.
//==============================================================================
