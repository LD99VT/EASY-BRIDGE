...
public:
    explicit UpdateChecker (juce::String latestReleaseApiUrl)
        : juce::Thread ("EasyBridgeUpdateChecker"),
    ...
    void run() override
    {
        ...
        auto options = juce::URL::InputStreamOptions (juce::URL::ParameterHandling::inAddress)
                           ...
                           .withExtraHeaders ("Accept: application/vnd.github+json\r\n"
                                              "User-Agent: EasyBridge/" + currentVer_ + "\r\n");
        ...
        releaseUrl_ = htmlUrl.isNotEmpty() ? htmlUrl : "https://github.com/LD99VT/EASY-BRIDGE/releases/latest";
