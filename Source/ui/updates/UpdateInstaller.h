...
public:
    UpdateInstaller()
        : juce::Thread ("EasyBridgeUpdateInstaller")
    {
    }
...
private:
    void run() override
    {
        ...
        auto options = juce::URL::InputStreamOptions (juce::URL::ParameterHandling::inAddress)
                           ...
                           .withExtraHeaders ("Accept: application/octet-stream\r\n"
                                              "User-Agent: EasyBridge/" + version_ + "\r\n");
    ...
    juce::File buildTargetFile() const
    {
        ...
        return tempDir.getChildFile ("EasyBridge_Update_" + juce::File::createLegalFileName (version_) + extension);
    }
